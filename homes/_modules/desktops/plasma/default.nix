...
with lib.hm.gvariant; {
  config = lib.mkIf osConfig.modules.desktops.plasma.enable {
    # add user packages
    ...
    #     enabled-extensions = ["appindicatorsupport@rgcjonas.gmail.com" "caffeine@patapon.info" "dash-to-dock@micxgx.gmail.com" "gsconnect@andyholmes.github.io" "sp-tray@sp-tray.esenliyim.github.com"];
