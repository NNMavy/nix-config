...
-- local workspace_switcher = wezterm.plugin.require("file:///Users/mavy/Development/Projects/smart_workspace_switcher.wezterm")
...
workspace_switcher.set_zoxide_path("/etc/profiles/per-user/mavy/bin/zoxide")
